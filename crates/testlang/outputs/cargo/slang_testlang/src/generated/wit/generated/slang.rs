            ...
            pub mod parser {
                ...
                impl ::core::fmt::Debug for NonterminalKind {
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        match self {
                            NonterminalKind::AdditionExpression => f
                                .debug_tuple("NonterminalKind::AdditionExpression")
                                .finish(),
                            NonterminalKind::Expression => {
                                f.debug_tuple("NonterminalKind::Expression").finish()
                            }
                            NonterminalKind::Literal => {
                                f.debug_tuple("NonterminalKind::Literal").finish()
                            }
                            NonterminalKind::MemberAccessExpression => f
                                .debug_tuple("NonterminalKind::MemberAccessExpression")
                                .finish(),
                            NonterminalKind::NegationExpression => f
                                .debug_tuple("NonterminalKind::NegationExpression")
                                .finish(),
                            NonterminalKind::SeparatedIdentifiers => f
                                .debug_tuple("NonterminalKind::SeparatedIdentifiers")
                                .finish(),
                            ...
                            NonterminalKind::Tree => {
                                f.debug_tuple("NonterminalKind::Tree").finish()
                            }
                            NonterminalKind::TreeNode => {
                                f.debug_tuple("NonterminalKind::TreeNode").finish()
                            }
                            NonterminalKind::TreeNodeChild => {
                                f.debug_tuple("NonterminalKind::TreeNodeChild").finish()
                            }
                            NonterminalKind::TreeNodeChildren => {
                                f.debug_tuple("NonterminalKind::TreeNodeChildren").finish()
                            }
                        }
                    }
                }
                ...
                impl ::core::fmt::Debug for EdgeLabel {
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        match self {
                            ...
                            EdgeLabel::Keyword => f.debug_tuple("EdgeLabel::Keyword").finish(),
                            ...
                            EdgeLabel::Node => f.debug_tuple("EdgeLabel::Node").finish(),
                    ...
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        match self {
                            ...
                            TerminalKind::DelimitedIdentifier => {
                                f.debug_tuple("TerminalKind::DelimitedIdentifier").finish()
                            }
                            ...
                            TerminalKind::StringLiteral => {
                                f.debug_tuple("TerminalKind::StringLiteral").finish()
                            }
                            TerminalKind::TreeKeyword => {
                                f.debug_tuple("TerminalKind::TreeKeyword").finish()
                            }
...
macro_rules! __export_slang_impl {
  ...
  const _: () = {
    ...
    #[doc(hidden)]
    pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 3430] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xea\x19\x01A\x02\x01\
...
query\x03\x01\x01r\x03\x07messages\x03rowy\x06columny\x04\0\x0bquery-error\x03\0\
