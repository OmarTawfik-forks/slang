...
export class UsingDirective {
  private readonly fetch = once(() => {
    const [$usingKeyword, $clause, $forKeyword, $target, $globalKeyword, $semicolon] = generated.ast.Selectors.sequence(
      this.cst,
    );
...
export class InterfaceDefinition {
  private readonly fetch = once(() => {
    const [$interfaceKeyword, $name, $inheritance, $openBrace, $members, $closeBrace] =
      generated.ast.Selectors.sequence(this.cst);
...
export class FunctionDefinition {
  private readonly fetch = once(() => {
    const [$functionKeyword, $name, $parameters, $attributes, $returns, $body] = generated.ast.Selectors.sequence(
      this.cst,
    );
...
export class EventDefinition {
  private readonly fetch = once(() => {
    const [$eventKeyword, $name, $parameters, $anonymousKeyword, $semicolon] = generated.ast.Selectors.sequence(
      this.cst,
    );
...
export class IfStatement {
  private readonly fetch = once(() => {
    const [$ifKeyword, $openParen, $condition, $closeParen, $body, $elseBranch] = generated.ast.Selectors.sequence(
      this.cst,
    );
...
export class ConditionalExpression {
  private readonly fetch = once(() => {
    const [$operand, $questionMark, $trueExpression, $colon, $falseExpression] = generated.ast.Selectors.sequence(
      this.cst,
    );
