...
impl BuiltIn {
    ...
    pub(super) const BLOBHASH_VERSIONS: LanguageVersionSpecifier =
        LanguageVersionSpecifier::from(LanguageVersion::V0_8_24);
    pub(super) const ERC_7201_VERSIONS: LanguageVersionSpecifier =
    ...
    pub(super) const FUNCTION_ADDRESS_VERSIONS: LanguageVersionSpecifier =
        LanguageVersionSpecifier::from(LanguageVersion::V0_8_2);
    pub(super) const UNWRAP_VERSIONS: LanguageVersionSpecifier =
        LanguageVersionSpecifier::from(LanguageVersion::V0_8_8);
    pub(super) const WRAP_VERSIONS: LanguageVersionSpecifier =
        LanguageVersionSpecifier::from(LanguageVersion::V0_8_8);
    ...
    pub(super) const YUL_BLOBHASH_VERSIONS: LanguageVersionSpecifier =
        LanguageVersionSpecifier::from(LanguageVersion::V0_8_24);
    pub(super) const YUL_CLZ_VERSIONS: LanguageVersionSpecifier =
