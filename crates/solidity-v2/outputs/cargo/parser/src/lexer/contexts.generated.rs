...
pub enum PragmaContext {
    ...
    #[regex(r#"'(?&VersionSpecifierFragment)(\.(?&VersionSpecifierFragment))*'"#, |_| { LexemeKind::SingleQuotedVersionLiteral }, priority = 2000002)]
    #[regex(r#""(?&VersionSpecifierFragment)(\.(?&VersionSpecifierFragment))*""#, |_| { LexemeKind::DoubleQuotedVersionLiteral }, priority = 2000003)]
...
#[logos(subpattern EscapeSequence = r#"\\([^xu]|(?&HexByteEscape)|(?&UnicodeEscape))"#)]
...
pub enum SolidityContext {
    ...
    #[regex(r#"0(x|X)(?&HexCharacter)+(_(?&HexCharacter)+)*"#, |_| { LexemeKind::HexLiteral }, priority = 2000181)]
    #[regex(r#"(?&DecimalDigits)(\.(?&DecimalDigits)?)?(?&DecimalExponent)?"#, |_| { LexemeKind::DecimalLiteral }, priority = 2000182)]
    #[regex(r#"\.(?&DecimalDigits)(?&DecimalExponent)?"#, |_| { LexemeKind::DecimalLiteral }, priority = 2000183)]
    #[regex(r#"'((?&EscapeSequence)|[^'\\\r\n])*'"#, |_| { LexemeKind::SingleQuotedStringLiteral }, priority = 2000184)]
    #[regex(r#""((?&EscapeSequence)|[^"\\\r\n])*""#, |_| { LexemeKind::DoubleQuotedStringLiteral }, priority = 2000185)]
    #[regex(r#"hex'(?&HexStringContents)?'"#, |_| { LexemeKind::SingleQuotedHexStringLiteral }, priority = 2000186)]
    #[regex(r#"hex"(?&HexStringContents)?""#, |_| { LexemeKind::DoubleQuotedHexStringLiteral }, priority = 2000187)]
    ...
    #[regex(r#"(?&IdentifierStart)(?&IdentifierPart)*"#, |_| { LexemeKind::Identifier }, priority = 2000190)]
...
#[logos(extras = ContextExtras)]
pub enum YulContext {
    #[regex(r#"(?&IdentifierStart)((?&IdentifierPart)|\.)*"#, |_| { LexemeKind::YulIdentifier }, priority = 2000001)]
    #[regex(r#"0|([1-9][0-9]*)"#, |_| { LexemeKind::YulDecimalLiteral }, priority = 2000002)]
    #[regex(r#"0x(?&HexCharacter)+"#, |_| { LexemeKind::YulHexLiteral }, priority = 2000003)]
