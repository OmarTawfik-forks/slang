...
pub enum PragmaContext {
    ...
    #[regex(r#"( |\t)+"#, |_| { LexemeKind::Whitespace }, priority = 1000011)]
    #[regex(r#"\n|(\r\n?)"#, |_| { LexemeKind::EndOfLine }, priority = 1000012)]
    #[regex(r#"//[^\r\n]*"#, |_| { LexemeKind::SingleLineComment }, priority = 1000013)]
    #[regex(r#"/\*[^\*]*\*+([^/\*][^\*]*\*+)*/"#, |_| { LexemeKind::MultiLineComment }, priority = 1000014)]
    #[regex(r#"///[^\r\n]*"#, |_| { LexemeKind::SingleLineNatSpecComment }, priority = 1000015)]
    #[regex(r#"/\*\*([^/\*][^\*]*)?\*+([^/\*][^\*]*\*+)*/"#, |_| { LexemeKind::MultiLineNatSpecComment }, priority = 1000016)]
    Lexeme(LexemeKind),
}
...
pub enum SolidityContext {
    ...
    #[regex(r#":="#, |_| { LexemeKind::ColonEqual }, priority = 2000134)]
    #[regex(r#"="#, |_| { LexemeKind::Equal }, priority = 2000135)]
    #[regex(r#"=:"#, |_| { LexemeKind::EqualColon }, priority = 2000136)]
    #[regex(r#"=="#, |_| { LexemeKind::EqualEqual }, priority = 2000137)]
    #[regex(r#"=>"#, |_| { LexemeKind::EqualGreaterThan }, priority = 2000138)]
    #[regex(r#"\*"#, |_| { LexemeKind::Asterisk }, priority = 2000139)]
    #[regex(r#"\*="#, |_| { LexemeKind::AsteriskEqual }, priority = 2000140)]
    #[regex(r#"\*\*"#, |_| { LexemeKind::AsteriskAsterisk }, priority = 2000141)]
    #[regex(r#"\|"#, |_| { LexemeKind::Bar }, priority = 2000142)]
    #[regex(r#"\|="#, |_| { LexemeKind::BarEqual }, priority = 2000143)]
    #[regex(r#"\|\|"#, |_| { LexemeKind::BarBar }, priority = 2000144)]
    #[regex(r#"&"#, |_| { LexemeKind::Ampersand }, priority = 2000145)]
    #[regex(r#"&="#, |_| { LexemeKind::AmpersandEqual }, priority = 2000146)]
    #[regex(r#"&&"#, |_| { LexemeKind::AmpersandAmpersand }, priority = 2000147)]
    #[regex(r#"<"#, |_| { LexemeKind::LessThan }, priority = 2000148)]
    #[regex(r#"<="#, |_| { LexemeKind::LessThanEqual }, priority = 2000149)]
    #[regex(r#"<<"#, |_| { LexemeKind::LessThanLessThan }, priority = 2000150)]
    #[regex(r#"<<="#, |_| { LexemeKind::LessThanLessThanEqual }, priority = 2000151)]
    #[regex(r#">"#, |_| { LexemeKind::GreaterThan }, priority = 2000152)]
    #[regex(r#">="#, |_| { LexemeKind::GreaterThanEqual }, priority = 2000153)]
    #[regex(r#">>"#, |_| { LexemeKind::GreaterThanGreaterThan }, priority = 2000154)]
    #[regex(r#">>="#, |_| { LexemeKind::GreaterThanGreaterThanEqual }, priority = 2000155)]
    #[regex(r#">>>"#, |_| { LexemeKind::GreaterThanGreaterThanGreaterThan }, priority = 2000156)]
    #[regex(r#">>>="#, |_| { LexemeKind::GreaterThanGreaterThanGreaterThanEqual }, priority = 2000157)]
    #[regex(r#"\+"#, |_| { LexemeKind::Plus }, priority = 2000158)]
    #[regex(r#"\+="#, |_| { LexemeKind::PlusEqual }, priority = 2000159)]
    #[regex(r#"\+\+"#, |_| { LexemeKind::PlusPlus }, priority = 2000160)]
    #[regex(r#"-"#, |_| { LexemeKind::Minus }, priority = 2000161)]
    #[regex(r#"-="#, |_| { LexemeKind::MinusEqual }, priority = 2000162)]
    #[regex(r#"--"#, |_| { LexemeKind::MinusMinus }, priority = 2000163)]
    #[regex(r#"->"#, |_| { LexemeKind::MinusGreaterThan }, priority = 2000164)]
    #[regex(r#"/"#, |_| { LexemeKind::Slash }, priority = 2000165)]
    #[regex(r#"/="#, |_| { LexemeKind::SlashEqual }, priority = 2000166)]
    #[regex(r#"%"#, |_| { LexemeKind::Percent }, priority = 2000167)]
    #[regex(r#"%="#, |_| { LexemeKind::PercentEqual }, priority = 2000168)]
    #[regex(r#"!"#, |_| { LexemeKind::Bang }, priority = 2000169)]
    #[regex(r#"!="#, |_| { LexemeKind::BangEqual }, priority = 2000170)]
    #[regex(r#"\^"#, |_| { LexemeKind::Caret }, priority = 2000171)]
    #[regex(r#"\^="#, |_| { LexemeKind::CaretEqual }, priority = 2000172)]
    #[regex(r#"~"#, |_| { LexemeKind::Tilde }, priority = 2000173)]
    #[regex(r#"0(x|X)(([0-9]|[a-f]|[A-F]))+(_(([0-9]|[a-f]|[A-F]))+)*"#, |_| { LexemeKind::HexLiteral }, priority = 2000174)]
    #[regex(r#"(([0-9]+(_[0-9]+)*))(\.(([0-9]+(_[0-9]+)*))?)?(((e|E)-?(([0-9]+(_[0-9]+)*))))?"#, |_| { LexemeKind::DecimalLiteral }, priority = 2000175)]
    #[regex(r#"\.(([0-9]+(_[0-9]+)*))(((e|E)-?(([0-9]+(_[0-9]+)*))))?"#, |_| { LexemeKind::DecimalLiteral }, priority = 2000176)]
    #[regex(r#"'(((\\([^xu]|((x(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))))|((u(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F])))))))|[^'\\\r\n])*'"#, |_| { LexemeKind::SingleQuotedStringLiteral }, priority = 2000177)]
    #[regex(r#""(((\\([^xu]|((x(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))))|((u(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F])))))))|[^"\\\r\n])*""#, |_| { LexemeKind::DoubleQuotedStringLiteral }, priority = 2000178)]
    #[regex(r#"hex'(((([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(_?(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F])))*))?'"#, |_| { LexemeKind::SingleQuotedHexStringLiteral }, priority = 2000179)]
    #[regex(r#"hex"(((([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(_?(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F])))*))?""#, |_| { LexemeKind::DoubleQuotedHexStringLiteral }, priority = 2000180)]
    #[regex(r#"unicode'(((\\(((n|r|t|'|"|\\|\r\n|\r|\n))|((x(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))))|((u(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F])))))))|[^'\\\r\n])*'"#, |_| { LexemeKind::SingleQuotedUnicodeStringLiteral }, priority = 2000181)]
    #[regex(r#"unicode"(((\\(((n|r|t|'|"|\\|\r\n|\r|\n))|((x(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))))|((u(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F]))(([0-9]|[a-f]|[A-F])))))))|[^"\\\r\n])*""#, |_| { LexemeKind::DoubleQuotedUnicodeStringLiteral }, priority = 2000182)]
    #[regex(r#"((_|\$|[a-z]|[A-Z]))((((_|\$|[a-z]|[A-Z]))|[0-9]))*"#, |_| { LexemeKind::Identifier }, priority = 2000183)]
    #[regex(r#"( |\t)+"#, |_| { LexemeKind::Whitespace }, priority = 1000184)]
    #[regex(r#"\n|(\r\n?)"#, |_| { LexemeKind::EndOfLine }, priority = 1000185)]
    #[regex(r#"//[^\r\n]*"#, |_| { LexemeKind::SingleLineComment }, priority = 1000186)]
    #[regex(r#"/\*[^\*]*\*+([^/\*][^\*]*\*+)*/"#, |_| { LexemeKind::MultiLineComment }, priority = 1000187)]
    #[regex(r#"///[^\r\n]*"#, |_| { LexemeKind::SingleLineNatSpecComment }, priority = 1000188)]
    #[regex(r#"/\*\*([^/\*][^\*]*)?\*+([^/\*][^\*]*\*+)*/"#, |_| { LexemeKind::MultiLineNatSpecComment }, priority = 1000189)]
    Lexeme(LexemeKind),
}
