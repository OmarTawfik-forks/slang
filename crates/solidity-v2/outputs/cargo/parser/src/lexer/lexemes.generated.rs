...
pub enum LexemeKind {
    ...
    PlusEqual,
    PlusPlus,
    PragmaABIEncoderV2Keyword_Unreserved,
    PragmaAbicoderKeyword_Unreserved,
    PragmaAbicoderV1Keyword_Unreserved,
    PragmaAbicoderV2Keyword_Unreserved,
    PragmaBarBar,
    PragmaCaret,
    PragmaDoubleQuotedStringLiteral,
    PragmaEqual,
    PragmaExperimentalKeyword_Unreserved,
    PragmaGreaterThan,
    ...
    PragmaMinus,
    PragmaPeriod,
    PragmaSMTCheckerKeyword_Unreserved,
    PragmaSemicolon,
    PragmaSingleQuotedStringLiteral,
    PragmaSolidityKeyword_Unreserved,
    PragmaTilde,
